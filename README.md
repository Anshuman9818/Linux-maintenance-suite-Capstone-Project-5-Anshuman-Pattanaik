...
```bash
git clone https://github.com/DevAshuTosh10/Linux-maintenance-Anshuman-Pattanaik.git
cd Linux-maintenance-Anshuman-Pattanaik
...
swift
Copy code
0 2 * * * /home/anshuman/maintenance_suite/backup.sh
0 3 * * 0 /home/anshuman/maintenance_suite/update.sh
*/15 * * * * /home/anshuman/maintenance_suite/logmonitor.sh
🧩 Developer Notes
